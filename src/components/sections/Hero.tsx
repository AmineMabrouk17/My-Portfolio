          ...
          <ScrollReveal>
            ...
            <div className="flex gap-3.5 mt-9">
              <a
                ...
                rel="noopener"
                aria-label="GitHub"
                className="w-[42px] h-[42px] grid place-items-center rounded-[11px] bg-white/[0.03] border border-[var(--color-accent)]/40 text-[var(--color-accent)] no-underline transition-all duration-200 hover:border-[var(--color-accent)] hover:-translate-y-0.5"
              >
